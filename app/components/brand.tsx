...
export function Brand({ className }: { className?: string }) {
  return (
    <span className={clsx('inline-flex items-center gap-2.5 font-mono text-[15px] tracking-tight', className)}>
      <RelayMark />
...
export function RelayMark({ size = 20 }: { size?: number }) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 64 64"
    ...
    >
      ...
      />
      <circle cx="49" cy="15" r="3.5" fill="#0b0c10" />
    </svg>
  )
}
