...
export const metadata: Metadata = {
  title: 'Privacy · Reley',
  description: 'How Reley handles data. Short answer: it does not collect any.',
}
...
export default function PrivacyPage() {
  return (
    <LegalShell kicker="Legal" title="Privacy policy" effective="2026-06-19">
      <p>
        Reley runs on your machine. No account, no sign-in, no analytics ping.
        This page exists so you do not have to dig through source to confirm
        that.
      </p>

      <h2>What Reley does not collect</h2>
      <ul>
        ...
        <li>No account on any backend - Reley has no backend.</li>
      </ul>
      ...
      <p>
        ...
        local test use only. Do not paste a real funded key into Reley.
      </p>

      <h2>Network requests Reley makes</h2>
      <ul>
        <li>
          <strong>Solana RPC.</strong> When you clone a program, account, or
          replay a transaction, Reley calls the RPC endpoint you configured.
      ...
      <h2>Children</h2>
      <p>
        Reley is a developer tool. It is not directed at children under 13. We
